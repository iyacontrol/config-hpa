...
func (r *ReconcileCHPA) reconcileCHPA(chpa *chpav1beta1.ConfigHpa) (err error) {
	defer func() {
...
func (r *ReconcileCHPA) computeReplicasForMetrics(chpa *chpav1beta1.ConfigHpa, scale *autoscalingv1.Scale, metricSpecs []autoscalingv2.MetricSpec) (replicas int32, metric string, statuses []autoscalingv2.MetricStatus, timestamp time.Time, err error) {
