...
import (
	...
	autoscalersv1beta1 "github.com/iyacontrol/config-hpa/pkg/apis/confighpa/v1beta1"
...
func TestReconcile(t *testing.T) {
	...
	instance := &autoscalersv1beta1.ConfigHpa{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
